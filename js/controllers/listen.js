...
function setForUpdateListen(id) {
    getData(`${URL}/api/googlestt/${id}`).then(edit => {
...
function enableListen(id) {
    getData(`${URL}/api/googlestt/${id}`).then(edit => {
        ...
        putData(`${URL}/api/googlestt/${id}`, edit)
            .then((data) => {
...
function deleteListen(id) {
    deleteData(`${URL}/api/googlestt/${id}`)
        .then((data) => {
